...
export default function ActiveSubscriptions() {
    return <>
        ...
        <div className="my-4 rounded-md border">
            <header className='flex flex-row items-center bg-gray-200 gap-2 p-3'>
                <CiCircleList className='text-2xl' />
                <h2>الإشتراكات المفعلة</h2>
            </header>
            <body className=''>
                <head className='p-6 flex flex-row bg-gray-400 justify-between items-center' >
                ...
                <info className='p-6 flex flex-row justify-between items-center'>
                    ...
                    <h5>	2030-12-31 </h5>
                    <h5> 	0.00 ر.س</h5>
                    <h5><CiCircleCheck className='text-2xl' /> </h5>
